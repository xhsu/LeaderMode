...
#define JOYSTICK_BUTTON( _joystick, _button ) ( (KeyCode)JOYSTICK_BUTTON_INTERNAL( _joystick, _button ) )
#define JOYSTICK_POV_BUTTON( _joystick, _button ) ( (KeyCode)JOYSTICK_POV_BUTTON_INTERNAL( _joystick, _button ) )
#define JOYSTICK_AXIS_BUTTON( _joystick, _button ) ( (KeyCode)JOYSTICK_AXIS_BUTTON_INTERNAL( _joystick, _button ) )
...
namespace vgui
{
	enum KeyCode
	{
		...
		// Mouse
		// LUNA: Disabled when used in GoldSrc
		...
		// Joystick
		JOYSTICK_FIRST = 114,//MOUSE_LAST + 1,
