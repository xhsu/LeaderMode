...
void CFuncTankGun::FireBullets(ULONG cShots, Vector vecSrc, Vector vecDirShooting, Vector vecSpread, float flDistance, int iBulletType, int iTracerFreq, int iDamage, entvars_t* pevAttacker)
{
		...
		if (tr.flFraction != 1.0f)
		{
			...
			else
			{
				...
				case BULLET_MONSTER_12MM:
					pEntity->TraceAttack(pevAttacker, 32, vecDir, &tr, DMG_BULLET);
