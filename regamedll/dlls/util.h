...
void UTIL_Play3DSound(const Vector& vecOrigin, float flRange, SharedString iSample, int iPitch = 100);
void UTIL_Play3DSoundWithHost2D(CBasePlayer* pHost, const Vector& vecSrc, float flRange, SharedString iSample, int iPitch = 100);
void UTIL_Play3DSoundWithoutHost(CBasePlayer* pHost, const Vector& vecSrc, float flRange, SharedString iSample, int iPitch = 100);
...
void UTIL_SendSecondaryVMDLAnim(CBasePlayer* pPlayer, int iSeq, bool bSkipLocal = true);
