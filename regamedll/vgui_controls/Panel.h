...
private:
	...
	CPanelAnimationVarAliasType( int, m_nBgTextureId1, "Texture1", "gfx/vgui/800corner1", "textureid" );
	CPanelAnimationVarAliasType( int, m_nBgTextureId2, "Texture2", "gfx/vgui/800corner2", "textureid" );
	CPanelAnimationVarAliasType( int, m_nBgTextureId3, "Texture3", "gfx/vgui/800corner3", "textureid" );
	CPanelAnimationVarAliasType( int, m_nBgTextureId4, "Texture4", "gfx/vgui/800corner4", "textureid" );
