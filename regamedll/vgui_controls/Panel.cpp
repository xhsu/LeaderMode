...
void Panel::ApplySchemeSettings(IScheme *pScheme)
{
	...
	m_nBgTextureId1 = surface()->DrawGetTextureId("gfx/vgui/800corner1");
	if (m_nBgTextureId1 == -1)
	{
		m_nBgTextureId1 = surface()->CreateNewTextureID();
		surface()->DrawSetTextureFile(m_nBgTextureId1, "gfx/vgui/800corner1", true, false);
	}
	m_nBgTextureId2 = surface()->DrawGetTextureId("gfx/vgui/800corner2");
	if (m_nBgTextureId2 == -1)
	{
		m_nBgTextureId2 = surface()->CreateNewTextureID();
		surface()->DrawSetTextureFile(m_nBgTextureId2, "gfx/vgui/800corner2", true, false);
	}
	m_nBgTextureId3 = surface()->DrawGetTextureId("gfx/vgui/800corner3");
	if (m_nBgTextureId3 == -1)
	{
		m_nBgTextureId3 = surface()->CreateNewTextureID();
		surface()->DrawSetTextureFile(m_nBgTextureId3, "gfx/vgui/800corner3", true, false);
	}
	m_nBgTextureId4 = surface()->DrawGetTextureId("gfx/vgui/800corner4");
	if (m_nBgTextureId4 == -1)
	{
		m_nBgTextureId4 = surface()->CreateNewTextureID();
		surface()->DrawSetTextureFile(m_nBgTextureId4, "gfx/vgui/800corner4", true, false);
	}
	if ( IsBuildGroupEnabled() )
	{
	...
	virtual void SetData( Panel *panel, KeyValues *kv, PanelAnimationMapEntry *entry )
	{
		...
		if ( texturename && texturename[ 0 ] )
		{
			...
			if ( currentId == -1 )
			{
				...
				surface()->DrawSetTextureFile( currentId, texturename, true, false );
			}
		}
